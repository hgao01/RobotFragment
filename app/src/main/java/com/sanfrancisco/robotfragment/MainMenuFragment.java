...
public class MainMenuFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<String>(getActivity(), layout, Ipsum.MainMenu));
        //show it as list view, this!=fragment, this==activity
    }
    ...
    public void onStart() {
        ...
        if (getFragmentManager().findFragmentById(R.id.story_fragment) != null) {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mCallback = (OnMainMenuSelectedListener) activity;
